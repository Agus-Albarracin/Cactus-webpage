    ...
    subtitulos: [
      {
        ...
        contenido: (
          <div className='space'>
            ...
            <br/><br/>
            <Image src="https://res.cloudinary.com/do1hcqjpe/image/upload/v1713482672/nussxjqhujvyqikhypno.jpg" width={1600} height={800} alt="profile object -> @react-oauth/google" />
            <br/><br/>
            ...
            <Image src="https://res.cloudinary.com/do1hcqjpe/image/upload/v1713481447/k8lnyqsbq66mgyk5kah8.jpg" width={1600} height={800} alt="Error al post, react-google-login" />
            <br/><br/>
            ...
            <br/><br/>
            <Image src="https://res.cloudinary.com/do1hcqjpe/image/upload/v1713479183/arix4qegjipu1svmqnko.png" width={1600} height={800} alt="Error al post, google-oauth-library" />
            <br/><br/>
          </div>
        )
      },
