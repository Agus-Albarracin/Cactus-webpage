...
export function Header() {
    ...
    return (
        <MotionTransition>
            <nav className="flex flex-wrap items-center justify-between max-w-5xl p-4 mx-auto md:py-20">
                <Link href="/" className="flex items-center">
                    <Image src="/assets/logo.png" width="270" height="100" alt="Logo Cactus" />
                </Link>
